...
var style_AirtemperaturedegreesCsensors_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Temperatur") !== null) {
        labelText = String(feature.get("Temperatur"));
    }
    if (value >= 20.749163 && value <= 21.812169) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 21.812169 && value <= 22.134736) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 22.134736 && value <= 22.822085) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 22.822085 && value <= 23.135257) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 23.135257 && value <= 24.385550) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
